...
namespace TesseractDotnetWrapper.Interop
{
    ...
    internal static class TessApi
    {
        ...
        {
            IntPtr versionHandle = NativeTessApiSignatures.GetVersion();
        ...
        {
            IntPtr txtHandle = NativeTessApiSignatures.BaseApiGetHOCRTextInternal(handle, pageNum);
            if (txtHandle != IntPtr.Zero)
            {
                var result = MarshalHelper.PtrToString(txtHandle, Encoding.UTF8);
                NativeTessApiSignatures.DeleteText(txtHandle);
        ...
        {
            IntPtr txtHandle = NativeTessApiSignatures.BaseApiGetAltoTextInternal(handle, pageNum);
            if (txtHandle != IntPtr.Zero)
            {
                var result = MarshalHelper.PtrToString(txtHandle, Encoding.UTF8);
                NativeTessApiSignatures.DeleteText(txtHandle);
        ...
        {
            IntPtr txtHandle = NativeTessApiSignatures.BaseApiGetTsvTextInternal(handle, pageNum);
            if (txtHandle != IntPtr.Zero)
            {
                var result = MarshalHelper.PtrToString(txtHandle, Encoding.UTF8);
                NativeTessApiSignatures.DeleteText(txtHandle);
        ...
        {
            IntPtr txtHandle = NativeTessApiSignatures.BaseApiGetBoxTextInternal(handle, pageNum);
            if (txtHandle != IntPtr.Zero)
            {
                var result = MarshalHelper.PtrToString(txtHandle, Encoding.UTF8);
                NativeTessApiSignatures.DeleteText(txtHandle);
        ...
        {
            IntPtr txtHandle = NativeTessApiSignatures.BaseApiGetLSTMBoxTextInternal(
                handle,
                pageNum
            );
            if (txtHandle != IntPtr.Zero)
        ...
        {
            IntPtr txtHandle = NativeTessApiSignatures.BaseApiGetWordStrBoxTextInternal(
                handle,
                pageNum
            );
            if (txtHandle != IntPtr.Zero)
        ...
        {
            IntPtr txtHandle = NativeTessApiSignatures.BaseApiGetUNLVTextInternal(handle);
            if (txtHandle != IntPtr.Zero)
            {
                var result = MarshalHelper.PtrToString(txtHandle, Encoding.UTF8);
                NativeTessApiSignatures.DeleteText(txtHandle);
        ...
        {
            var resultHandle = NativeTessApiSignatures.BaseApiGetStringVariableInternal(
                handle,
                name
            );
        ...
        {
            IntPtr txtHandle = NativeTessApiSignatures.BaseAPIGetUTF8TextInternal(handle);
            if (txtHandle != IntPtr.Zero)
            {
                var result = MarshalHelper.PtrToString(txtHandle, Encoding.UTF8);
                NativeTessApiSignatures.DeleteText(txtHandle);
        ...
        )
        {
            ...
            return NativeTessApiSignatures.BaseApiInit(
                handle,
                datapath,
                language,
                mode,
        ...
        public static int BaseApiSetDebugVariable(HandleRef handle, string name, string value)
        {
            ...
            try
            {
                ...
                return NativeTessApiSignatures.BaseApiSetDebugVariable(handle, name, valuePtr);
            }
            finally
            {
        ...
        public static int BaseApiSetVariable(HandleRef handle, string name, string value)
        {
            ...
            {
                valuePtr = MarshalHelper.StringToPtr(value, Encoding.UTF8);
                return NativeTessApiSignatures.BaseApiSetVariable(handle, name, valuePtr);
            }
            finally
            {
                if (valuePtr != IntPtr.Zero)
        ...
        public static string? ResultIteratorWordRecognitionLanguage(HandleRef handle)
        {
            ...
            IntPtr txtHandle =
                NativeTessApiSignatures.ResultIteratorWordRecognitionLanguageInternal(handle);
        ...
        {
            IntPtr txtHandle = NativeTessApiSignatures.ResultIteratorGetUTF8TextInternal(
                handle,
                level
            );
            if (txtHandle != IntPtr.Zero)
        ...
        internal static string ChoiceIteratorGetUTF8Text(HandleRef choiceIteratorHandle)
        {
            ...
            IntPtr txtChoiceHandle = NativeTessApiSignatures.ChoiceIteratorGetUTF8TextInternal(
                choiceIteratorHandle
            );
