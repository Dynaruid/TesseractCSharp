...
namespace TesseractDotnetWrapper.Interop
{
    ...
    public class NativeTessApiWindows : INativeTessApi
    {
        [DllImport(
            NativeConstants.TesseractWinX64DllName,
        ...
        // The following were causing issues on Linux/MacOsX when used in .net core//[DllImport(NativeConstants.TesseractWinX64DllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIProcessPages")]//int BaseAPIProcessPages(HandleRef handle, string filename, string retry_config, int timeout_millisec, HandleRef renderer);
        //[DllImport(NativeConstants.TesseractWinX64DllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "TessBaseAPIProcessPage")]//int BaseAPIProcessPage(HandleRef handle, Pix pix, int page_index, string filename, string retry_config, int timeout_millisec, HandleRef renderer);
        [DllImport(
            NativeConstants.TesseractWinX64DllName,
            CallingConvention = CallingConvention.Cdecl,
    ...
    public class NativeLeptonicaApiWindow : INativeLeptonicaApi
    {
        #region PixA
        [DllImport(
            NativeConstants.LeptonicaWinX64DllName,
            CallingConvention = CallingConvention.Cdecl,
