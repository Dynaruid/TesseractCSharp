...
namespace TesseractCSharp
{
    ...
    public class PageIterator : DisposableBase
    {
        ...
        public void Begin()
        {
            ...
            {
                NativeTessApi.PageIteratorBegin(handle);
            }
        }
        ...
        public bool Next(PageIteratorLevel level)
        {
            ...
            if (handle.Handle == IntPtr.Zero)
                return false;
            return NativeTessApi.PageIteratorNext(handle, level) != 0;
        }
        ...
        public bool IsAtBeginningOf(PageIteratorLevel level)
        {
            ...
            if (handle.Handle == IntPtr.Zero)
                return false;
            return NativeTessApi.PageIteratorIsAtBeginningOf(handle, level) != 0;
        }
        ...
        public bool IsAtFinalOf(PageIteratorLevel level, PageIteratorLevel element)
        {
            ...
            if (handle.Handle == IntPtr.Zero)
                return false;
            return NativeTessApi.PageIteratorIsAtFinalElement(handle, level, element) != 0;
        }
        ...
        public PolyBlockType BlockType
        {
            get
            {
                ...
                return NativeTessApi.PageIteratorBlockType(handle);
            }
        }
        ...
        public Pix GetBinaryImage(PageIteratorLevel level)
        {
            ...
            return Pix.Create(NativeTessApi.PageIteratorGetBinaryImage(handle, level));
        }
        ...
        public Pix GetImage(PageIteratorLevel level, int padding, out int x, out int y)
        {
            ...
            return Pix.Create(
                NativeTessApi.PageIteratorGetImage(
                    handle,
                    level,
                    padding,
                    page.Image.Handle,
        ...
        public bool TryGetBoundingBox(PageIteratorLevel level, out Rect bounds)
        {
            ...
            if (
                ...
                && NativeTessApi.PageIteratorBoundingBox(
                    handle,
                    level,
                    out x1,
                    out y1,
        ...
        public bool TryGetBaseline(PageIteratorLevel level, out Rect bounds)
        {
            ...
            if (
                handle.Handle != IntPtr.Zero
                && NativeTessApi.PageIteratorBaseline(
                    handle,
                    level,
                    out x1,
                    out y1,
        ...
        public ElementProperties GetProperties()
        {
            ...
            float deskew_angle;
            NativeTessApi.PageIteratorOrientation(
                handle,
                out orientation,
        ...
        protected override void Dispose(bool disposing)
        {
            if (handle.Handle != IntPtr.Zero)
            {
                NativeTessApi.PageIteratorDelete(handle);
            }
        }
    }
}
