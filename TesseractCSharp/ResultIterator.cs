...
namespace TesseractCSharp
{
    public sealed class ResultIterator : PageIterator
    {
        ...
        public float GetConfidence(PageIteratorLevel level)
        {
            ...
            return NativeTessApi.ResultIteratorGetConfidence(handle, level);
        }
        ...
        public FontAttributes? GetWordFontAttributes()
        {
            ...
            IntPtr nameHandle = NativeTessApi.ResultIteratorWordFontAttributes(
                handle,
                out isBold,
                out isItalic,
                out isUnderlined,
        ...
        public bool GetWordIsFromDictionary()
        {
            ...
            return NativeTessApi.ResultIteratorWordIsFromDictionary(handle);
        }
        ...
        public bool GetWordIsNumeric()
        {
            ...
            return NativeTessApi.ResultIteratorWordIsNumeric(handle);
        }
        ...
        public bool GetSymbolIsSuperscript()
        {
            ...
            return NativeTessApi.ResultIteratorSymbolIsSuperscript(handle);
        }
        ...
        public bool GetSymbolIsSubscript()
        {
            ...
            return NativeTessApi.ResultIteratorSymbolIsSubscript(handle);
        }
        ...
        public bool GetSymbolIsDropcap()
        {
            ...
            return NativeTessApi.ResultIteratorSymbolIsDropcap(handle);
        }
        ...
        {
            var choiceIteratorHandle = NativeTessApi.ResultIteratorGetChoiceIterator(
                this.handle
            );
