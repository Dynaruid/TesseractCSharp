...
{
    /// <summary>
    /// Rendered formats supported by TesseractDotnetWrapper.
    /// </summary>
    ...
    public abstract class ResultRenderer : DisposableBase, IResultRenderer
    {
            ...
            protected override void Dispose(bool disposing)
            {
                try
                {
                    if (disposing)
                    {
                        ...
                        // End the renderer
                        NativeTessApi.ResultRendererEndDocument(_renderer._handle);
        ...
        public bool AddPage(Page page)
        {
            ...
            return NativeTessApi.ResultRendererAddImage(Handle, page.Engine.Handle) != 0;
        }
        ...
        public IDisposable BeginDocument(string title)
        {
            ...
            if (NativeTessApi.ResultRendererBeginDocument(Handle, titlePtr) == 0)
            {
        ...
        public int PageNumber
        {
            get
            {
                ...
                return NativeTessApi.ResultRendererImageNum(Handle);
            }
        }
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            finally
            {
                ...
                {
                    NativeTessApi.DeleteResultRenderer(_handle);
                    _handle = new HandleRef(this, IntPtr.Zero);
                }
            }
        }
    ...
    public sealed class TextResultRenderer : ResultRenderer
    {
        ...
        {
            var rendererHandle = NativeTessApi.TextRendererCreate(outputFilename);
    ...
    public sealed class HOcrResultRenderer : ResultRenderer
    {
        ...
        {
            var rendererHandle = NativeTessApi.HOcrRendererCreate2(
                outputFilename,
                fontInfo ? 1 : 0
            );
            Initialise(rendererHandle);
    ...
    public sealed class UnlvResultRenderer : ResultRenderer
    {
        ...
        {
            var rendererHandle = NativeTessApi.UnlvRendererCreate(outputFilename);
            Initialise(rendererHandle);
        }
    }
    ...
    public sealed class AltoResultRenderer : ResultRenderer
    {
        ...
        {
            var rendererHandle = NativeTessApi.AltoRendererCreate(outputFilename);
            Initialise(rendererHandle);
        }
    }
    ...
    public sealed class TsvResultRenderer : ResultRenderer
    {
        ...
        {
            var rendererHandle = NativeTessApi.TsvRendererCreate(outputFilename);
            Initialise(rendererHandle);
        }
    }
    ...
    public sealed class LSTMBoxResultRenderer : ResultRenderer
    {
        ...
        {
            var rendererHandle = NativeTessApi.LSTMBoxRendererCreate(outputFilename);
            Initialise(rendererHandle);
        }
    }
    ...
    public sealed class WordStrBoxResultRenderer : ResultRenderer
    {
        ...
        {
            var rendererHandle = NativeTessApi.WordStrBoxRendererCreate(outputFilename);
            Initialise(rendererHandle);
        }
    }
    ...
    public sealed class BoxResultRenderer : ResultRenderer
    {
        ...
        {
            var rendererHandle = NativeTessApi.BoxTextRendererCreate(outputFilename);
            Initialise(rendererHandle);
        }
    }
    ...
    public sealed class PdfResultRenderer : ResultRenderer
    {
        ...
        public PdfResultRenderer(string outputFilename, string fontDirectory, bool textonly)
        {
            ...
            var rendererHandle = NativeTessApi.PDFRendererCreate(
                outputFilename,
                fontDirectoryHandle,
                textonly ? 1 : 0
            );
