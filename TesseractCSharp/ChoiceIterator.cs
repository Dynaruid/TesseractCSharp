    ...
    public sealed class ChoiceIterator : DisposableBase
    {
        ...
        public bool Next()
        {
            ...
            if (_handleRef.Handle == IntPtr.Zero)
                return false;
            return NativeTessApi.ChoiceIteratorNext(_handleRef) != 0;
        }
        ...
        public float GetConfidence()
        {
            ...
            return NativeTessApi.ChoiceIteratorGetConfidence(_handleRef);
        }
        ...
        protected override void Dispose(bool disposing)
        {
            if (_handleRef.Handle != IntPtr.Zero)
            {
                NativeTessApi.ChoiceIteratorDelete(_handleRef);
            }
        }
    }
}
