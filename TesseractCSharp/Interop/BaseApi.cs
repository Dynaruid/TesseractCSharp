...
namespace TesseractCSharp.Interop
{
    ...
    internal static class TessApi
    {
        ...
        {
            IntPtr versionHandle = NativeTessApi.GetVersion();
        ...
        {
            IntPtr txtHandle = NativeTessApi.BaseApiGetHOCRTextInternal(handle, pageNum);
            if (txtHandle != IntPtr.Zero)
            {
                var result = MarshalHelper.PtrToString(txtHandle, Encoding.UTF8);
                NativeTessApi.DeleteText(txtHandle);
        ...
        {
            IntPtr txtHandle = NativeTessApi.BaseApiGetAltoTextInternal(handle, pageNum);
            if (txtHandle != IntPtr.Zero)
            {
                var result = MarshalHelper.PtrToString(txtHandle, Encoding.UTF8);
                NativeTessApi.DeleteText(txtHandle);
        ...
        {
            IntPtr txtHandle = NativeTessApi.BaseApiGetTsvTextInternal(handle, pageNum);
            if (txtHandle != IntPtr.Zero)
            {
                var result = MarshalHelper.PtrToString(txtHandle, Encoding.UTF8);
                NativeTessApi.DeleteText(txtHandle);
        ...
        {
            IntPtr txtHandle = NativeTessApi.BaseApiGetBoxTextInternal(handle, pageNum);
            if (txtHandle != IntPtr.Zero)
            {
                var result = MarshalHelper.PtrToString(txtHandle, Encoding.UTF8);
                NativeTessApi.DeleteText(txtHandle);
        ...
        {
            IntPtr txtHandle = NativeTessApi.BaseApiGetLSTMBoxTextInternal(handle, pageNum);
            if (txtHandle != IntPtr.Zero)
            {
                var result = MarshalHelper.PtrToString(txtHandle, Encoding.UTF8);
                NativeTessApi.DeleteText(txtHandle);
        ...
        {
            IntPtr txtHandle = NativeTessApi.BaseApiGetWordStrBoxTextInternal(handle, pageNum);
            if (txtHandle != IntPtr.Zero)
            {
                var result = MarshalHelper.PtrToString(txtHandle, Encoding.UTF8);
                NativeTessApi.DeleteText(txtHandle);
        ...
        {
            IntPtr txtHandle = NativeTessApi.BaseApiGetUNLVTextInternal(handle);
            if (txtHandle != IntPtr.Zero)
            {
                var result = MarshalHelper.PtrToString(txtHandle, Encoding.UTF8);
                NativeTessApi.DeleteText(txtHandle);
        ...
        {
            var resultHandle = NativeTessApi.BaseApiGetStringVariableInternal(handle, name);
        ...
        {
            IntPtr txtHandle = NativeTessApi.BaseAPIGetUTF8TextInternal(handle);
            if (txtHandle != IntPtr.Zero)
            {
                var result = MarshalHelper.PtrToString(txtHandle, Encoding.UTF8);
                NativeTessApi.DeleteText(txtHandle);
        ...
        )
        {
            ...
            return NativeTessApi.BaseApiInit(
                handle,
                datapath,
                language,
                mode,
        ...
        public static int BaseApiSetDebugVariable(HandleRef handle, string name, string value)
        {
            ...
            try
            {
                ...
                return NativeTessApi.BaseApiSetDebugVariable(handle, name, valuePtr);
            }
            finally
            {
        ...
        public static int BaseApiSetVariable(HandleRef handle, string name, string value)
        {
            ...
            {
                valuePtr = MarshalHelper.StringToPtr(value, Encoding.UTF8);
                return NativeTessApi.BaseApiSetVariable(handle, name, valuePtr);
            }
            finally
            {
                if (valuePtr != IntPtr.Zero)
        ...
        public static string? ResultIteratorWordRecognitionLanguage(HandleRef handle)
        {
            ...
            IntPtr txtHandle = NativeTessApi.ResultIteratorWordRecognitionLanguageInternal(
                handle
            );
        ...
        {
            IntPtr txtHandle = NativeTessApi.ResultIteratorGetUTF8TextInternal(handle, level);
            if (txtHandle != IntPtr.Zero)
            {
                var result = MarshalHelper.PtrToString(txtHandle, Encoding.UTF8);
                NativeTessApi.DeleteText(txtHandle);
        ...
        internal static string ChoiceIteratorGetUTF8Text(HandleRef choiceIteratorHandle)
        {
            ...
            IntPtr txtChoiceHandle = NativeTessApi.ChoiceIteratorGetUTF8TextInternal(
                choiceIteratorHandle
            );
