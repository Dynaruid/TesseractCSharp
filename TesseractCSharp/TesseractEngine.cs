...
namespace TesseractCSharp
{
    ...
    public class TesseractEngine : DisposableBase
    {
        ...
        )
        {
            ...
            handle = new HandleRef(this, NativeTessApi.BaseApiCreate());
        ...
        )
        {
            ...
            var actualPageSegmentMode = pageSegMode.HasValue
                ? pageSegMode.Value
                : DefaultPageSegMode;
            NativeTessApi.BaseAPISetPageSegMode(handle, actualPageSegmentMode);
            NativeTessApi.BaseApiSetImage(handle, image.Handle);
            if (!String.IsNullOrEmpty(inputName))
            {
                NativeTessApi.BaseApiSetInputName(handle, inputName);
            }
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            {
                NativeTessApi.BaseApiDelete(handle);
        ...
        {
            int val;
            if (NativeTessApi.BaseApiGetBoolVariable(handle, name, out val) != 0)
            {
                value = (val != 0);
                return true;
            }
        ...
        {
            return NativeTessApi.BaseApiGetDoubleVariable(handle, name, out value) != 0;
        }
        ...
        {
            return NativeTessApi.BaseApiGetIntVariable(handle, name, out value) != 0;
        }
        ...
        {
            return NativeTessApi.BaseApiPrintVariablesToFile(handle, filename) != 0;
        }
