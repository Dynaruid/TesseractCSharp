...
using TesseractCSharp.Internal;
...
namespace TesseractCSharp
{
    public sealed unsafe class Pix : DisposableBase, IEquatable<Pix>
    {
        ...
        private Pix(IntPtr handle)
        {
            ...
            this.width = NativeLeptonicaApi.pixGetWidth(this.handle);
            this.height = NativeLeptonicaApi.pixGetHeight(this.handle);
            this.depth = NativeLeptonicaApi.pixGetDepth(this.handle);

            var colorMapHandle = NativeLeptonicaApi.pixGetColormap(this.handle);
        ...
        public static Pix Create(int width, int height, int depth)
        {
            ...
            var handle = NativeLeptonicaApi.pixCreate(width, height, depth);
            if (handle == IntPtr.Zero)
        ...
        {
            var pixHandle = NativeLeptonicaApi.pixRead(filename);
        ...
        public static Pix LoadFromMemory(byte[] bytes)
        {
            ...
            {
                handle = NativeLeptonicaApi.pixReadMem(ptr, bytes.Length);
            }
            if (handle == IntPtr.Zero)
            {
        ...
        public static Pix LoadTiffFromMemory(byte[] bytes)
        {
            ...
            fixed (byte* ptr = bytes)
            {
                handle = NativeLeptonicaApi.pixReadMemTiff(ptr, bytes.Length, 0);
            }
            if (handle == IntPtr.Zero)
            {
                throw new IOException("Failed to load image from memory.");
        ...
        {
            IntPtr handle;
            handle = NativeLeptonicaApi.pixReadFromMultipageTiff(filename, ref offset);
        ...
        public PixColormap Colormap
        {
            ...
            set
            {
                if (value != null)
                {
                    if (NativeLeptonicaApi.pixSetColormap(handle, value.Handle) == 0)
                    {
                        colormap = value;
                    }
                }
                ...
                {
                    if (NativeLeptonicaApi.pixDestroyColormap(handle) == 0)
                    {
                        colormap = null;
                    }
                }
        ...
        public int XRes
        {
            get { return NativeLeptonicaApi.pixGetXRes(this.handle); }
            set { NativeLeptonicaApi.pixSetXRes(this.handle, value); }
        }

        public int YRes
        {
            get { return NativeLeptonicaApi.pixGetYRes(this.handle); }
            set { NativeLeptonicaApi.pixSetYRes(this.handle, value); }
        }
        ...
        public bool Equals(Pix other)
        {
            ...
            int same;
            if (NativeLeptonicaApi.pixEqual(Handle, other.Handle, out same) != 0)
            {
        ...
        public void Save(string filename, ImageFormat? format = null)
        {
            ...
            if (NativeLeptonicaApi.pixWrite(filename, handle, actualFormat) != 0)
            {
        ...
        public Pix Clone()
        {
            var clonedHandle = NativeLeptonicaApi.pixClone(handle);
        ...
        )
        {
            ...
            IntPtr ppixth,
                ppixd;
            int result = NativeLeptonicaApi.pixOtsuAdaptiveThreshold(
                handle,
                sx,
                sy,
                smoothx,
            ...
            if (ppixth != IntPtr.Zero)
            {
                ...
                NativeLeptonicaApi.pixDestroy(ref ppixth);
            }
        ...
        public Pix BinarizeSauvola(int whsize, float factor, bool addborder)
        {
            ...
            IntPtr ppixm,
                ...
                ppixth,
                ppixd;
            int result = NativeLeptonicaApi.pixSauvolaBinarize(
                handle,
                whsize,
                factor,
                addborder ? 1 : 0,
            ...
            {
                NativeLeptonicaApi.pixDestroy(ref ppixm);
            }

            if (ppixsd != IntPtr.Zero)
            {
                NativeLeptonicaApi.pixDestroy(ref ppixsd);
            }
        ...
        public Pix BinarizeSauvolaTiled(int whsize, float factor, int nx, int ny)
        {
            ...
            IntPtr ppixth,
                ppixd;
            int result = NativeLeptonicaApi.pixSauvolaBinarizeTiled(
                handle,
                whsize,
                factor,
                nx,
        ...
        public Pix ConvertRGBToGray(float rwt, float gwt, float bwt)
        {
            ...
            var resultPixHandle = NativeLeptonicaApi.pixConvertRGBToGray(
                handle,
                rwt,
                gwt,
                bwt
        ...
        public Pix RemoveLines()
        {
            ...
            try
            {
                ...
                pix1 = NativeLeptonicaApi.pixThresholdToBinary(handle, 170);

                /* find the skew angle and deskew using an interpolated
                 * rotator for anti-aliasing (to avoid jaggies) */
                NativeLeptonicaApi.pixFindSkew(new HandleRef(this, pix1), out angle, out conf);
                pix2 = NativeLeptonicaApi.pixRotateAMGray(
                    handle,
                    (float)(Deg2Rad * angle),
                    (byte)255
                );
                ...
                pix3 = NativeLeptonicaApi.pixCloseGray(new HandleRef(this, pix2), 51, 1);

                /* solidify the lines to be removed */
                pix4 = NativeLeptonicaApi.pixErodeGray(new HandleRef(this, pix3), 1, 5);

                /* clean the background of those lines */
                pix5 = NativeLeptonicaApi.pixThresholdToValue(
                ...
                pix6 = NativeLeptonicaApi.pixThresholdToValue(
                    new HandleRef(this, IntPtr.Zero),
                ...
                pix7 = NativeLeptonicaApi.pixThresholdToBinary(new HandleRef(this, pix6), 210);
                ...
                NativeLeptonicaApi.pixInvert(
                    new HandleRef(this, pix6),
                    new HandleRef(this, pix6)
                );
                pix8 = NativeLeptonicaApi.pixAddGray(
                    new HandleRef(this, IntPtr.Zero),
                    new HandleRef(this, pix2),
                    new HandleRef(this, pix6)
                );

                pix9 = NativeLeptonicaApi.pixOpenGray(new HandleRef(this, pix8), 1, 9);

                NativeLeptonicaApi.pixCombineMasked(
            ...
            finally
            {
                ...
                if (pix1 != IntPtr.Zero)
                {
                    NativeLeptonicaApi.pixDestroy(ref pix1);
                }

                if (pix2 != IntPtr.Zero)
                {
                    NativeLeptonicaApi.pixDestroy(ref pix2);
                }

                if (pix3 != IntPtr.Zero)
                {
                    NativeLeptonicaApi.pixDestroy(ref pix3);
                }

                if (pix4 != IntPtr.Zero)
                {
                    NativeLeptonicaApi.pixDestroy(ref pix4);
                }

                if (pix5 != IntPtr.Zero)
                {
                    NativeLeptonicaApi.pixDestroy(ref pix5);
                }

                if (pix6 != IntPtr.Zero)
                {
                    NativeLeptonicaApi.pixDestroy(ref pix6);
                }

                if (pix7 != IntPtr.Zero)
                {
                    NativeLeptonicaApi.pixDestroy(ref pix7);
                }

                if (pix9 != IntPtr.Zero)
                {
                    NativeLeptonicaApi.pixDestroy(ref pix9);
                }
            }
        }
        ...
        public Pix Despeckle(string selStr, int selSize)
        {
            ...
            pix1 = NativeLeptonicaApi.pixBackgroundNormFlex(handle, 7, 7, 1, 1, 10);

            /* Remove the background */
            pix2 = NativeLeptonicaApi.pixGammaTRCMasked(
                new HandleRef(this, IntPtr.Zero),
            ...
            /* Binarize */
            pix3 = NativeLeptonicaApi.pixThresholdToBinary(new HandleRef(this, pix2), 180);

            /* Remove the speckle noise up to selSize x selSize */
            sel1 = NativeLeptonicaApi.selCreateFromString(
                selStr,
                selSize + 2,
                selSize + 2,
                "speckle" + selSize
            );
            pix4 = NativeLeptonicaApi.pixHMT(
                new HandleRef(this, IntPtr.Zero),
                new HandleRef(this, pix3),
                new HandleRef(this, sel1)
            );
            sel2 = NativeLeptonicaApi.selCreateBrick(selSize, selSize, 0, 0, SelType.SEL_HIT);
            pix5 = NativeLeptonicaApi.pixDilate(
                new HandleRef(this, IntPtr.Zero),
                new HandleRef(this, pix4),
                new HandleRef(this, sel2)
            );
            pix6 = NativeLeptonicaApi.pixSubtract(
                new HandleRef(this, IntPtr.Zero),
                new HandleRef(this, pix3),
                new HandleRef(this, pix5)
            );

            NativeLeptonicaApi.selDestroy(ref sel1);
            NativeLeptonicaApi.selDestroy(ref sel2);
        ...
        public Pix Deskew(ScewSweep sweep, int redSearch, int thresh, out Scew scew)
        {
            float pAngle,
                pConf;
            var resultPixHandle = NativeLeptonicaApi.pixDeskewGeneral(
                handle,
                sweep.Reduction,
                sweep.Range,
                sweep.Delta,
        ...
        )
        {
            ...
            if (Math.Abs(rotations - Math.Floor(rotations)) < VerySmallAngle)
            {
                ...
                resultHandle = NativeLeptonicaApi.pixRotateOrth(handle, (int)rotations);
            }
            else
            {
                // handle general case
                resultHandle = NativeLeptonicaApi.pixRotate(
                    handle,
                    angleInRadians,
                    method,
                    fillColor,
        ...
        {
            IntPtr resultHandle = NativeLeptonicaApi.pixRotate90(handle, direction);
        ...
        public Pix Invert()
        {
            IntPtr resultHandle = NativeLeptonicaApi.pixInvert(
                new HandleRef(this, IntPtr.Zero),
                handle
            );
        ...
        {
            IntPtr resultHandle = NativeLeptonicaApi.pixConvertTo8(handle, cmapflag);
        ...
        {
            IntPtr result = NativeLeptonicaApi.pixScale(handle, scaleX, scaleY);
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            NativeLeptonicaApi.pixDestroy(ref tmpHandle);
